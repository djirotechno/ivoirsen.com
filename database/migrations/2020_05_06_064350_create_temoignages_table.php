...
class CreateTemoignagesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Temoignages", 'temoignages', 'temoin', 'fa-cube', [
            ["temoin", "Temoin", "String", false, "", 0, 256, true],
            ["contenu", "contenu", "Textarea", false, "", 0, 0, false],
            ["image", "Image", "Dropdown", false, "", 0, 0, false, "@uploads"],
            ["profile", "Profile", "String", false, "", 0, 256, true],
        ]);
    ...
    {
        if (Schema::hasTable('temoignages')) {
