...
class CreateContactsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Contacts", 'contacts', 'adresse', 'fa-cube', [
            ["adresse", "adresse", "Address", false, "", 0, 256, true],
            ["telephone", "tellephone", "Mobile", false, "", 0, 20, true],
            ["email", "email", "Email", false, "", 0, 256, true],
            ["pays", "pays", "String", true, "", 0, 256, true],
        ]);
