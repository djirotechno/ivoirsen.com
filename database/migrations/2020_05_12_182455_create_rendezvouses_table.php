...
class CreateRendezvousesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Rendezvouses", 'rendezvouses', 'nom', 'fa-cube', [
            ["nom", "nom", "String", false, "", 0, 256, false],
            ["prenom", "prenom", "String", false, "", 0, 256, false],
            ["telephone", "telephone", "Integer", false, "", 0, 11, false],
            ["email", "email", "Email", false, "", 0, 256, false],
            ["message", "message", "TextField", false, "", 0, 256, false],
        ]);
