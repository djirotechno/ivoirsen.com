	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $expert->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			...
			@la_access("Experts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.experts.destroy', $expert->id], 'method' => 'delete', 'style'=>'display:inline']) }}
