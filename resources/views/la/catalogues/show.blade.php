...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $catalogue->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Catalogues", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/catalogues/'.$catalogue->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Catalogues", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.catalogues.destroy', $catalogue->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/catalogues') }}" data-toggle="tooltip" data-placement="right" title="Back to Catalogues"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'titre')
						@la_display($module, 'objectif')
						@la_display($module, 'contenu')
						@la_display($module, 'duree')
						@la_display($module, 'date')
						@la_display($module, 'prix')
						@la_display($module, 'niveaux')
						@la_display($module, 'intervenant')
						@la_display($module, 'outilslogiciel')
						@la_display($module, 'prerequis')
