...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $cvpdg->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Cvpdgs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/cvpdgs/'.$cvpdg->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Cvpdgs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cvpdgs.destroy', $cvpdg->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cvpdgs') }}" data-toggle="tooltip" data-placement="right" title="Back to Cvpdgs"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'experience')
						@la_display($module, 'diplome')
						@la_display($module, 'recherchepub')
						@la_display($module, 'autreRecherche')
						@la_display($module, 'association')
						@la_display($module, 'informatique')
						@la_display($module, 'langue')
						@la_display($module, 'reference')
					</div>
				</div>
			</div>
		</div>
